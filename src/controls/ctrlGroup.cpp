 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_ButtonClick(const uint32_t ctrl_id)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_EditEnter(const uint32_t ctrl_id)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_EditChange(const uint32_t ctrl_id)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_TabChange(const uint32_t ctrl_id, const uint16_t tab_id)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_ListSelectItem(const uint32_t ctrl_id, const uint16_t selection)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_ComboSelectItem(const uint32_t ctrl_id, const uint16_t selection)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_CheckboxChange(const uint32_t ctrl_id, const bool checked)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_ProgressChange(const uint32_t ctrl_id, const uint16_t position)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_ScrollShow(const uint32_t ctrl_id, const bool visible)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_OptionGroupChange(const uint32_t ctrl_id, const uint16_t selection)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Timer(const uint32_t ctrl_id)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_TableSelectItem(const uint32_t ctrl_id, const uint16_t selection)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_TableRightButton(const uint32_t ctrl_id, const uint16_t selection)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_TableLeftButton(const uint32_t ctrl_id, const uint16_t selection)
{
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_ButtonClick(const uint32_t group_id, const uint32_t ctrl_id)
{
    parent->Msg_Group_ButtonClick(this->id, ctrl_id);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_EditEnter(const uint32_t group_id, const uint32_t ctrl_id)
{
    parent->Msg_Group_EditEnter(this->id, ctrl_id);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_EditChange(const uint32_t group_id, const uint32_t ctrl_id)
{
    parent->Msg_Group_EditChange(this->id, ctrl_id);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_TabChange(const uint32_t group_id, const uint32_t ctrl_id, const uint16_t tab_id)
{
    parent->Msg_Group_TabChange(this->id, ctrl_id, tab_id);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_ListSelectItem(const uint32_t group_id, const uint32_t ctrl_id, const uint16_t selection)
{
    parent->Msg_Group_ListSelectItem(this->id, ctrl_id, selection);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_ComboSelectItem(const uint32_t group_id, const uint32_t ctrl_id, const uint16_t selection)
{
    parent->Msg_Group_ComboSelectItem(this->id, ctrl_id, selection);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_CheckboxChange(const uint32_t group_id, const uint32_t ctrl_id, const bool checked)
{
    parent->Msg_Group_CheckboxChange(this->id, ctrl_id, checked);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_ProgressChange(const uint32_t group_id, const uint32_t ctrl_id, const uint16_t position)
{
    parent->Msg_Group_ProgressChange(this->id, ctrl_id, position);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_ScrollShow(const uint32_t group_id, const uint32_t ctrl_id, const bool visible)
{
    parent->Msg_Group_ScrollShow(this->id, ctrl_id, visible);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_OptionGroupChange(const uint32_t group_id, const uint32_t ctrl_id, const uint16_t selection)
{
    parent->Msg_Group_OptionGroupChange(this->id, ctrl_id, selection);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_Timer(const uint32_t group_id, const uint32_t ctrl_id)
{
    parent->Msg_Group_Timer(this->id, ctrl_id);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_TableSelectItem(const uint32_t group_id, const uint32_t ctrl_id, const uint16_t selection)
{
    parent->Msg_Group_TableSelectItem(this->id, ctrl_id, selection);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_TableRightButton(const uint32_t group_id, const uint32_t ctrl_id, const uint16_t selection)
{
    parent->Msg_Group_TableRightButton(this->id, ctrl_id, selection);
}
 ...
 *  @author OLiver
 */
void ctrlGroup::Msg_Group_TableLeftButton(const uint32_t group_id, const uint32_t ctrl_id, const uint16_t selection)
{
    parent->Msg_Group_TableLeftButton(this->id, ctrl_id, selection);
}
